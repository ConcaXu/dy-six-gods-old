...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_4, mod_consts[35]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_6, mod_consts[36]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_end_1:;
    {
        ...
        }
        {
            ...
            tmp_dict_value_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_9, mod_consts[4]);
            ...
            tmp_annotations_3 = _PyDict_NewPresized( 4 );
            {
                ...
                tmp_dict_value_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_11, mod_consts[47]);
                if (tmp_dict_value_2 == NULL) {
                    assert(ERROR_OCCURRED());
                ...
                tmp_dict_value_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_12, mod_consts[4]);
